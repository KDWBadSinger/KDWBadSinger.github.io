var API_key = "RGAPI-8349b502-8a87-4165-a14a-ad47f25635ff";
var server_url= "";
const Regions = [
...
async function data()
{
    ...
    // 控制台：玩家完整信息（AccID, ID, Icon ID, puuid, Level）
    ...
    // document.getElementById("summonerlevel_data").innerHTML ="Level is "+summoner_Level;
    ...
    // document.getElementById("ranked_division").innerHTML = "<img src='RankIcon/"+division_tier+".png' width=100 height=100>"+division+" "+lp_ranked+" LP";
    ...
    for(let l=0;l<20;l++)
    {
        ...
        let matchDurion = dataChamp.timePlayed;
    ...
    for(let m=0;m<champStatsFinal.length;m++)
    {
        ...
        champStatsCode += "<div id='currentChamp'><img src='Champion ICON/"+champStatsFinal[m][0]+".jpg' width='200' height='200'></br>KDA: "+kdaChamp.toFixed(2)+"</br>"+champAK.toFixed(2)+" | "+champAD.toFixed(2)+" | "
                       +champAS.toFixed(2)+"</br>AVG CS: "+champACS.toFixed(2)+"</br>"+champWinratio+"%"+"</br>Matches played: "+champMatchesPlayed/2+"</div id='currentChamp'>";
        ...
        matchHistoryCode += "</div><div id = 'matchStats'>"+matchStatsA[m]+"</br>KDA:"+kdaChamp.toFixed(2)+"</div><div id='blueTeam'>"
        for(let i = 0;i<5;i++)
        {
    ...
    document.getElementById("newData").innerHTML = summonerInfoCode;
